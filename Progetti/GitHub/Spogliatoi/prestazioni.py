...
cnv = canvas.Canvas("Adige.pdf", pagesize=A4)
cnv.drawString(43, 150, durata)
cnv.drawString(43, 180, f)

cnv.drawImage("image/Library.png", 43, 621.87, width= 508, height= 196.13)
cnv.drawImage("image/Profilo.png", 43, 366, width= 508, height= 223)
cnv.save()
